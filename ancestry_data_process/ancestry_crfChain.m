...
[trainErr,TP,FP,FN] = crfChain_error(w,v_start,v_end,v,X,y,nStates,nFeatures,featureStart,sentences(trainNdx,:),'decode',useMex)
precision=TP/(TP+FP)
recall=TP/(TP+FN)
[testErr,TP,FP,FN] = crfChain_error(w,v_start,v_end,v,X,y,nStates,nFeatures,featureStart,sentences(testNdx,:),'decode',useMex)
precision=TP/(TP+FP)
recall=TP/(TP+FN)
